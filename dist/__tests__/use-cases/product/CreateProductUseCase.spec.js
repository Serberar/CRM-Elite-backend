...
describe('CreateProductUseCase', () => {
    ...
    const mockProduct = new Product_1.Product('product-123', 'Test Product', 'Test Description', 'SKU-123', 99.99, true, new Date(), new Date());
    beforeEach(() => {
        jest.clearAllMocks();
        mockRepository = {
            create: jest.fn(),
        ...
        crypto_1.default.randomUUID.mockReturnValue('product-123');
    });
    describe('execute', () => {
        ...
        it('should create a product with null description and sku', async () => {
            ...
            const minimalProduct = new Product_1.Product('product-123', 'Minimal Product', null, null, 49.99, true, new Date(), new Date());
        ...
        it('should throw AuthorizationError when user lacks permission', async () => {
            ...
            await expect(useCase.execute(mockProductData, userWithoutPermission)).rejects.toThrow(AppError_1.AuthorizationError);
            expect(mockRepository.create).not.toHaveBeenCalled();
        });
        it('should generate a unique UUID for the product', async () => {
            crypto_1.default.randomUUID.mockReturnValue('unique-uuid-123');
            mockRepository.create.mockResolvedValue(mockProduct);
        ...
        it('should only work with administrador role', async () => {
            ...
            await expect(useCase.execute(mockProductData, coordinadorUser)).rejects.toThrow(AppError_1.AuthorizationError);
        });
        it('should handle numeric price correctly', async () => {
            ...
            const productWithPrice = new Product_1.Product('product-123', 'Test Product', 'Test Description', 'SKU-123', 0.01, true, new Date(), new Date());
        ...
        it('should handle large prices', async () => {
            ...
            const productWithLargePrice = new Product_1.Product('product-123', 'Test Product', 'Test Description', 'SKU-123', 999999.99, true, new Date(), new Date());
        ...
        it('should create products with special characters in name', async () => {
            ...
            const productWithSpecialName = new Product_1.Product('product-123', 'Product™ & Co. (2024)', 'Test Description', 'SKU-123', 99.99, true, new Date(), new Date());
