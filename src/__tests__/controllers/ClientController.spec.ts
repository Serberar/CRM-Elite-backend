...
describe('ClientController', () => {
  ...
  describe('getClient', () => {
    it('debería devolver 404 si no hay clientes', async () => {
      ...
      await ClientController.getClient(req as any, res as any);
  ...
  describe('createClient', () => {
    it('debería crear un cliente correctamente', async () => {
      ...
      await ClientController.createClient(req as any, res as any);
  ...
  describe('updateClient', () => {
    it('debería actualizar cliente correctamente', async () => {
      ...
      await ClientController.updateClient(req as any, res as any);
  ...
  describe('pushClientData', () => {
    it('debería añadir datos correctamente', async () => {
      ...
      await ClientController.pushClientData(req as any, res as any);
